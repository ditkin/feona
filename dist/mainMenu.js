...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainMenu = function (_HTMLElement) {
	  ...
	  _createClass(MainMenu, [{
	    ...
	    value: function createdCallback() {
	      ...
	      var func = function func(e) {
	        this.mountElement(e.currentTarget.id, shadowRoot);
	      };
	    ...
	    key: 'mountElement',
	    value: function mountElement(elementType, shadowRoot) {
	      var url = elementType + '.html';
	      history.pushState(null, elementType, url);
	      var cont = shadowRoot.getElementById('app-container');
